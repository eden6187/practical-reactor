...
public class c5_CreatingSequence {
    ...
    public void potentially_null_mono() {
        ...
        Mono<String> potentiallyNullMono = Mono.justOrEmpty(Optional.empty()); //todo change this line only
    ...
    @Test
    public void range() {
        Flux<Integer> range = Flux.range(-5,5-(-5)+1); //todo: change this line only
    ...
    public void repeat() {
        ...
        Flux<Integer> repeated = Mono.fromCallable(() -> counter.addAndGet(1))
                        .repeat(9);
